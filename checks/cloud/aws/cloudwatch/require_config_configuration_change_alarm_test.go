	...
	}{
		{
			...
			cloudwatch: cloudwatch.CloudWatch{
				LogGroups: []cloudwatch.LogGroup{
					{
						...
						MetricFilters: []cloudwatch.MetricFilter{
							{
								Metadata:      misscanTypes.NewTestMetadata(),
								FilterName:    misscanTypes.String("ConfigConfigurationChange", misscanTypes.NewTestMetadata()),
								FilterPattern: misscanTypes.String(`{($.eventSource=config.amazonaws.com) && (($.eventName=StopConfigurationRecorder) || ($.eventName=DeleteDeliveryChannel) || ($.eventName=PutDeliveryChannel) || ($.eventName=PutConfigurationRecorder))}`, misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
				Alarms: []cloudwatch.Alarm{
					{
						Metadata:   misscanTypes.NewTestMetadata(),
						AlarmName:  misscanTypes.String("ConfigConfigurationChange", misscanTypes.NewTestMetadata()),
						MetricName: misscanTypes.String("ConfigConfigurationChange", misscanTypes.NewTestMetadata()),
						Metrics: []cloudwatch.MetricDataQuery{
							{
								Metadata: misscanTypes.NewTestMetadata(),
								ID:       misscanTypes.String("ConfigConfigurationChange", misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
