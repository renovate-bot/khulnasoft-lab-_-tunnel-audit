				...
				LogGroups: []cloudwatch.LogGroup{
					{
						...
						MetricFilters: []cloudwatch.MetricFilter{
							{
								Metadata:      misscanTypes.NewTestMetadata(),
								FilterName:    misscanTypes.String("UnauthorizedAPIUsage", misscanTypes.NewTestMetadata()),
								FilterPattern: misscanTypes.String(`($.errorCode = "*UnauthorizedOperation") || ($.errorCode = "AccessDenied*")`, misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
				Alarms: []cloudwatch.Alarm{
					{
						...
						MetricName: misscanTypes.String("UnauthorizedAPIUsage", misscanTypes.NewTestMetadata()),
						Metrics: []cloudwatch.MetricDataQuery{
							{
								Metadata: misscanTypes.NewTestMetadata(),
								ID:       misscanTypes.String("UnauthorizedAPIUsage", misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
