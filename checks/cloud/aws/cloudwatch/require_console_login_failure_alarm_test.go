	...
	}{
		{
			...
			cloudwatch: cloudwatch.CloudWatch{
				LogGroups: []cloudwatch.LogGroup{
					{
						...
						MetricFilters: []cloudwatch.MetricFilter{
							{
								Metadata:      misscanTypes.NewTestMetadata(),
								FilterName:    misscanTypes.String("ConsoleLoginFailure", misscanTypes.NewTestMetadata()),
								FilterPattern: misscanTypes.String(`{($.eventName=ConsoleLogin) && ($.errorMessage="Failed authentication")}`, misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
				Alarms: []cloudwatch.Alarm{
					{
						Metadata:   misscanTypes.NewTestMetadata(),
						AlarmName:  misscanTypes.String("ConsoleLoginFailure", misscanTypes.NewTestMetadata()),
						MetricName: misscanTypes.String("ConsoleLoginFailure", misscanTypes.NewTestMetadata()),
						Metrics: []cloudwatch.MetricDataQuery{
							{
								Metadata: misscanTypes.NewTestMetadata(),
								ID:       misscanTypes.String("ConsoleLoginFailure", misscanTypes.NewTestMetadata()),
							},
						},
					},
				},
